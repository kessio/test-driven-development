...
# 📖 [Test Driven Devlopment] <a name="about-project"></a>

> In this project implemented a class with some methods, used test-driven development (TDD). Wrote tests first and then the code.
> **[TDD]** is a..
